 ...
 * that prevents user interaction with the site.
 * This function checks for existing messages and injects necessary styles 
 * before creating and displaying the blocking message.
 * 
 * @returns {void} - No return value, but it will block your access like a strict teacher! 
 * Jab site block hota hai, toh samajh lo, time ka limit ho gaya hai!
 */
